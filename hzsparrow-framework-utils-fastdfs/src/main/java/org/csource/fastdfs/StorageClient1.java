...
public class StorageClient1 extends StorageClient {
     ...
     * @param file_ext_name file ext name, do not include dot(.), null to extract ext name from the
     *        local filename
     ...
     *        </ul>
     *        <ul>
     *        <li>ProtoCommon.STORAGE_SET_METADATA_FLAG_MERGE: merge, insert when the metadata item
     *        not exist, otherwise update it</li>
     *        </ul>
